...
void interface::setupSystemInterface() {
  ...
  // Size
  TwDefine(" 'System' size='300 300'");
  TwDefine(" 'System' position='0 484'");
  ...
  TwAddButton(systemInterface,"savebn", saveFile, NULL, " label='Save Scenario' ");
  TwAddButton(systemInterface,"loadbn", loadFile, NULL, " label='Load Scenario' ");
}
