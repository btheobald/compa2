...
\paragraph{}
While this would be an issue for rendering full circles at close up distances, it will still be possible to render singular points, GL_POINTS will always render, regardless of how small the body itself it, and is far more tolerant to the loss in precision, because of this, the limit for distance will be set at $\num{1e15} (m)$
