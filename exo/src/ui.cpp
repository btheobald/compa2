...
void setupBodyGUI(render* renderAP) {
  ...
  TwAddVarRO(bodyGUI, "bodyid", TW_TYPE_INT32,   &activeID,          "                                              label='Selected Body' ");
...
void setupSuperStructGUI(render* renderAP) {
  ...
  TwDefine(" 'Superstructure' size='300 310'");
  ...
  TwAddVarRW(ssGUI, "nbodies", TW_TYPE_INT32,  &ss.bodies,  " min=0     max=10000 step=1    precision=4   label='# of Outer Bodies' group='System'");
  ...
  TwAddVarRW(ssGUI, "scolor",  TW_TYPE_COLOR3F,&ss.color,   " coloralpha=false                            label='Colour'                group='System' ");

  TwAddVarRW(ssGUI, "cmass",   TW_TYPE_DOUBLE, &ss.cMass,   " min=1E-4  max=1E40  step=0.1  precision=4   label='Mass'   group='Central Body'");
  TwAddVarRW(ssGUI, "cradi",   TW_TYPE_DOUBLE, &ss.cRadius, " min=1E-4  max=1E14  step=0.1  precision=4   label='Radius' group='Central Body'");

  TwAddVarRW(ssGUI, "omass",   TW_TYPE_DOUBLE, &ss.oMass,   " min=1E-4  max=1E40  step=0.1  precision=4   label='Mass'   group='Outer Body'");
  TwAddVarRW(ssGUI, "oradi",   TW_TYPE_DOUBLE, &ss.oRadius, " min=1E-4  max=1E14  step=0.1  precision=4   label='Radius' group='Outer Body'");

  TwAddVarRW(ssGUI, "cposx",   TW_TYPE_DOUBLE, &ss.cPX,     " min=-1E16 max=1E16  step=0.1  precision=4   label='X' group='Central Position'");
  TwAddVarRW(ssGUI, "cposy",   TW_TYPE_DOUBLE, &ss.cPY,     " min=-1E16 max=1E16  step=0.1  precision=4   label='Y' group='Central Position'");

  TwAddVarRW(ssGUI, "cvelx",   TW_TYPE_DOUBLE, &ss.cVX,     " min=-3E8  max=3E8   step=0.1  precision=4   label='X' group='Central Velocity'");
  TwAddVarRW(ssGUI, "cvely",   TW_TYPE_DOUBLE, &ss.cVY,     " min=-3E8  max=3E8   step=0.1  precision=4   label='Y' group='Central Velocity'");
