...
\pagebreak
\subsubsection{\LaTeX - Document Authoring}
\paragraph{}
Both this document and the manual for the application will be typeset using the \LaTeX word processor, Documents are written in comprehensive mark-up language which can then be compiled into a variety of formats, such as .pdf.
