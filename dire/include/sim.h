...
float calculateAcceleration(body* bA, body* bB);          // Calculate acceleration bettween two bodies, using force calculation and mass, returns value

void itteration(int cbc); // Itteration call, pass current body count
